...
public class RecycleItemAdapterTypeCourse extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void bind(ItemViewHolder holder, int position){
        ...
        if (results.get(position).getLive_status().equals("0")) {
                holder.tv_live_status.setText(results.get(position).getType().equals("0") ? "直播课":"录播课");
//            if (results.get(position).getType().equals("0")) {
//                holder.tv_live_status.setText("直播课");
//            } else if (results.get(position).getType().equals("1")) {
//                holder.tv_live_status.setText("录播课");
//            }
