package com.aidingyun.ynlive.mvp.ui.widget.gallery;
...
//        helper.attachToRecyclerView(mRecyclerView);
    ...
    private void onScrolledChangedCallback() {
        ...
        if (currentView != null) {
            // y = (mScale - 1)x + 1
            currentView.setScaleY((1 - mScale) * percent + mScale);//与相邻图片大小保持一致
//            currentView.setScaleY((mScale - 1) * percent + 1);//选中图片突出显示放大显示
        }
        if (rightView != null) {
            // y = (1 - mScale)x + mScale
